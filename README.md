...
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&size=50&duration=2000&pause=1000&color=FF6B35&center=true&vCenter=true&width=600&height=100&lines=🚀+InboxTriage+🚀;📧+InboxTriage+📧;🤖+InboxTriage+🤖;⚡+InboxTriage+⚡" alt="Animated Logo" />
...
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&size=22&duration=2500&pause=800&color=00D4AA&center=true&vCenter=true&width=900&lines=🤖+MULTI-AGENT+AI+SYSTEM+THAT+NEVER+SLEEPS;🛡️+ADVANCED+ML+SPAM+DETECTION+%2B+FILTERING;🧠+GEMINI+%2B+MISTRAL+AI+FOR+CONTENT+ANALYSIS;📊+BEAUTIFUL+REPORTS+WITH+SENTIMENT+INSIGHTS;📱+INSTANT+WHATSAPP+NOTIFICATIONS+%2B+ACTIONS;💬+RAG+CHAT+FOR+INTELLIGENT+EMAIL+QUERIES;📅+AUTO-SCHEDULE+MEETINGS+WITH+CALENDAR+API" alt="Solution" />

<img src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=12,20,6&height=3&section=header" width="80%">
...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=1500&pause=300&color=FF6B35&center=true&vCenter=true&width=900&lines=⚡+<30+SECONDS+END-TO-END+LATENCY;🎯+>95%25+DELIVERY+SUCCESS+RATE;🛡️+>90%25+SPAM+DETECTION+ACCURACY;💬+<5+SECONDS+RAG+RESPONSE+TIME" alt="Performance" />
